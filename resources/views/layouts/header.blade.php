...
@endif
@php
    // dd(url(Storage::url(env('LOGO1'))));
@endphp
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="{{ URL::to('/') }}"> <img src="{{ env('LOGO1') ? url('public'. Storage::url('public/'.  env('LOGO1'))) : url('public/assets/logo.svg') }}" alt="logo"> </a> <a class="navbar-brand brand-logo-mini" href="{{ URL::to('/') }}"> <img src="{{ asset('public/storage/' . env('FAVICON')) }}" alt="logo"> </a>
    </div>
