...
<script src="{{ asset('public//assets/js/ekko-lightbox.min.js') }}"></script>


<script src="{{ asset('public//assets/bootstrap-table/bootstrap-table.min.js') }}"></script>
<script src="{{ asset('public//assets/bootstrap-table/bootstrap-table-mobile.js') }}"></script>
<script src="{{ asset('public//assets/bootstrap-table/bootstrap-table-export.min.js') }}"></script>
<script src="{{ asset('public//assets/bootstrap-table/fixed-columns.min.js') }}"></script>
<script src="{{ asset('public//assets/bootstrap-table/tableExport.min.js') }}"></script>
<script src="{{ asset('public//assets/bootstrap-table/jspdf.min.js') }}"></script>
<script src="{{ asset('public//assets/bootstrap-table/jspdf.plugin.autotable.js') }}"></script>
...
<script src="{{ asset('public//assets/js/jquery.repeater.js') }}"></script>
<script src="{{ asset('public//assets/tinymce/tinymce.min.js') }}"></script>

<script src="{{ asset('public//assets/color-picker/jquery-asColor.min.js') }}"></script>
<script src="{{ asset('public//assets/color-picker/color.min.js') }}"></script>

<script src="{{ asset('public//assets/js/custom/validate.js') }}"></script>
<script src="{{ asset('public//assets/js/jquery-additional-methods.min.js') }}"></script>
<script src="{{ asset('public//assets/js/custom/function.js') }}"></script>
<script src="{{ asset('public//assets/js/custom/custom.js') }}"></script>
<script src="{{ asset('public//assets/js/custom/custom-bootstrap-table.js') }}"></script>

<script src="{{ asset('public//assets/ckeditor-4/ckeditor.js') }}"></script>
<script src="{{ asset('public//assets/ckeditor-4/adapters/jquery.js') }}" async></script>
