                            ...
                            <div class="row">
                                <div class="form-group col-md-4 col-sm-12">
                                    ...
                                    <div class="input-group col-xs-12">
                                        ...
                                        <div class="col-md-12">
                                            <img height="50px" src='{{ isset($settings['favicon']) ?url('public/'. Storage::url($settings['favicon'])) : '' }}'>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-md-4 col-sm-12">
                                    ...
                                    <div class="input-group col-xs-12">
                                        ...
                                        <div class="col-md-12">
                                            <img height="50px" src='{{ isset($settings['logo1']) ? url('public/'. Storage::url($settings['logo1'])) : '' }}'>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group col-md-4 col-sm-12">
                                    ...
                                    <div class="input-group col-xs-12">
                                        ...
                                        <div class="col-md-12">
                                            <img height="50px" src='{{ isset($settings['logo2']) ?  url('public/'. Storage::url($settings['logo2'])) : '' }}'>
                                        </div>
                                    </div>
                                </div>
                            </div>
